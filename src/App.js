...
import { IoCameraSharp, IoTelescopeOutline } from 'react-icons/io5';
...
import TelescopeControl from './components/Telescope';
...
function App() {
  ...
  const controls = [
    ...
    {
      id: 'framing_and_focus',
      label: 'Framing & Focus',
      icon: <MdOutlineFilterFrames />,
    },
    {
      id: 'telescope',
      label: 'Telescope Controls',
  ...
  const miscLinks = [
    ...
    },
    {
      ...
      link: 'https://www.wunderground.com/dashboard/pws/KWAELLEN214',
    },
    {
      id: 'webcams',
      label: 'Webcams',
      icon: <IoCameraSharp />,
      link: 'https://depts.washington.edu/mrouser/webcams/',
    },
    {
      id: 'feedback',
      label: 'Feedback',
      icon: <VscFeedback />,
      link: 'https://forms.gle/eknU5CgwkPckrHs58',
    },
  ];
    ...
    <div className="container">
      <button
        ...
        style={{
          left: sideBarHidden
            ? '0'
            : `${Math.max(280, window.innerWidth * 0.135)}px`,
        }}
      >
      ...
      <div
        ...
        style={{
          width: sideBarHidden
            ? '99.5%'
            : `${
                window.innerWidth * 0.25 > 350 ? `calc(100% - 320px)` : '83%'
              }`,
        }}
      >
        {!infoBarHidden && (
              ...
              <div class="infoBarGrid">
                <div>
                  ...
                  <span style={{ color: initialized ? '#5bcc09' : '' }}>
                    {initialized ? currTemp + ' C°' : 'N/A'}
                  </span>
                </div>
                <div>
                  <span>Filter:</span>
                  <span style={{ color: initialized ? '#5bcc09' : 'orange' }}>
                    {filterType}
                  </span>
                </div>
                <div>
                  <span>Time left:</span>
                  <span style={{ color: initialized ? '#5bcc09' : '' }}>
                    {initialized ? formatTime(currTimer) : 'N/A'}
                  </span>
                </div>
                <div>
                  <span>Status:</span>
